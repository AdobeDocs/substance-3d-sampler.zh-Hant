...
>[!NOTE]
>
> 在 **匯出視窗**&#x200B;中，更改材質模型選項會讓匯出的檔案名稱與所選材質模型相符。

![選擇材質設定的匯出視窗](../../assets/6.0_ExportWindowMaterialSettings.png)

Sampler 支援主要的素材檔案格式：

* 資料可匯出為 **SBS** 或 **SBSAR**&#x200B;檔案。
* 另外，材質也可以匯出以下檔案格式的每個通道點陣紋理：
  * **EXR**
  * **JPEG**
  * **巴布亞新幾內亞**
  * **塔爾加**

...
| 應用類型 | 啟動過程 |
| --- | --- |
| 創意雲端桌面 | 請參閱 HelpX 文件[&#128279;](https://helpx.adobe.com/support/substance-3d-sampler.html)中的專屬頁面。若有任何問題， [Creative Cloud 的文件](https://helpx.adobe.com/creative-cloud/user-guide.html) 可能會提供更多解答。 |

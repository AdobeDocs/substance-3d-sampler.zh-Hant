...
從 4.5 Sampler 版本開始，你現在可以直接將素材從 Sampler 傳送到任何已實作 Connector 的應用程式。\
它允許一鍵將素材從 Sampler 傳送到第三方應用程式，避免手動匯出與匯入流程，避免浪費時間。

如今，Send-to 已在 Blender、Unreal Engine、Unity、3ds Max 和 Maya 透過 Substance 插件提供。

## 支援的應用程式版本

要使用 Send-to，必須擁有 Sampler、第三方應用程式及外掛的正確版本。

以下是你必須使用Send-to所需的最低版本：

* <b>Unreal Engine 外掛</b>
  * UE5.4 之後的版本都完全支援。
  * *於 UE 市集發行*
